 ...
 * {@link Bottom.OnFragmentInteractionListener} interface
...
public class Bottom extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Oper = (TextView)view.findViewById(R.id.txtOp);
        Bal = (TextView)view.findViewById(R.id.txtBal);
        return view;
    }
    ...
    public void CalculateDaata(String RequestedAmount, String Operation){
        float amount = Float.valueOf(RequestedAmount);
